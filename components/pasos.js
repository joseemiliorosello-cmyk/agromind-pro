...
const renderUbicacion = () => {
  ...
  const renderAnalisis = () => {
    ...
    <div>
      ...
      {/* ══ TABS: Resumen · Diagnóstico · Balance · Cerebro ══ */}
      <div>
          <div style={{ display:"flex", gap:3, marginBottom:12, overflowX:"auto", scrollbarWidth:"none" }}>
            {[["resumen","🏅"],["diagnostico","🔍"],["balance","📊"],["cerebro","🧠"]].map(([k,l]) => (
...
export { GraficoCCEscenarios, PanelAgua, PanelFaseCiclo, LoadingPanel };
