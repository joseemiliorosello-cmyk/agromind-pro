...
export const CITAS = {
  ...
  "wiltbank1962": {
    id: "wiltbank1962",
    nivel: "N1",
    autores: "Wiltbank, J.N.; Rowden, W.W.; Ingalls, J.E.; Gregory, K.E.; Koch, R.M.",
    anio: 1962,
    titulo: "Effect of energy level on reproductive phenomena of mature Hereford cows",
    revista: "Journal of Animal Science",
    volumen: "21",
    paginas: "219-225",
    doi: "10.2527/jas1962.212219x",
    citaCorta: "Wiltbank et al. 1962",
    resumen: "Papel fundacional sobre el efecto del nivel energético preparto y posparto en el anestro y la tasa de preñez. Base mecanística de la relación CC → anestro → preñez.",
    tablasCubiertas: ["calcAnestro", "bloqueo_LH", "CC_PR"]
  },

  "moore1999": {
    id: "moore1999",
    nivel: "N1",
    autores: "Moore, J.E.; Brant, M.H.; Kunkle, W.E.; Hopkins, D.I.",
    anio: 1999,
    titulo: "Effects of supplementation on voluntary forage intake, diet digestibility, and animal performance",
    revista: "Journal of Animal Science",
    volumen: "77 (E-Suppl 2)",
    paginas: "122-135",
    citaCorta: "Moore et al. 1999",
    resumen: "Base técnica del efecto del suplemento sobre el consumo voluntario de forraje. Sustitución vs suplementación real según tipo de suplemento y calidad del forraje base.",
    tablasCubiertas: ["recomendarSuplemento", "umbral_PB_7", "suplementacion_proteica"]
  },

  "kunkle2000": {
    id: "kunkle2000",
    nivel: "N1",
    autores: "Kunkle, W.E.; Sand, R.S.; Rae, D.O.",
    anio: 2000,
    titulo: "Effect of body condition on productiviy in beef cattle",
    revista: "Factors Affecting Calf Crop (Fields & Sands, eds.)",
    editorial: "CRC Press",
    paginas: "167-178",
    citaCorta: "Kunkle et al. 2000",
    resumen: "Relación cuantitativa entre CC al parto y CC al servicio y preñez resultante. Fundamento de los umbrales de CC por categoría y momento del ciclo.",
    tablasCubiertas: ["CC_PR", "calcTrayectoriaCC", "umbral_CC_serv"]
  },
  ...
  "nasem2016": {
    id: "nasem2016",
    nivel: "N2",
    autores: "National Academies of Sciences, Engineering, and Medicine (NASEM)",
    anio: 2016,
    titulo: "Nutrient Requirements of Beef Cattle",
    revista: "8th revised edition",
    editorial: "The National Academies Press, Washington DC",
    doi: "10.17226/19014",
    citaCorta: "NASEM 2016",
    resumen: "Edición actualizada de los requerimientos nutricionales para bovinos de carne. Incluye requerimientos por categoría (vaca gestante, lactando, vaquillona, toro) y estación. Mejora el modelado de metabolismo energético respecto a NRC 2000.",
    tablasCubiertas: ["reqEM", "calcVaq1", "calcVaq2", "COSTO_KG_VAQ", "reqProteinaNeta"]
  },
