...
// ─── SUPLEMENTOS
// precioRefUsd: precio de referencia NEA 2025 en USD/kg (solo orientativo — varía por zona y campaña)
const SUPLEMENTOS = {
  ...
  "Expeller soja":      { pb:44,  em:2.80, tipo:"P",  degProt:65, degEner:75, label:"Expeller soja",                         precioRefUsd:0.31 },
  "Expeller girasol":   { pb:36,  em:2.60, tipo:"P",  degProt:60, degEner:72, label:"Expeller girasol",                      precioRefUsd:0.26 },
  "Expeller algodón":   { pb:36,  em:2.70, tipo:"P",  degProt:60, degEner:72, label:"Expeller algodón",                      precioRefUsd:0.22 },
  "Semilla algodón":    { pb:23,  em:2.95, tipo:"EP", degProt:55, degEner:78, label:"Semilla algodón (bypass + grasa)",       precioRefUsd:0.21 },
  "Urea tamponada":     { pb:280, em:0.00, tipo:"P",  degProt:100,degEner:0,  label:"Urea tamponada (+ azufre siempre)",      precioRefUsd:0.43 },
  "Pellet girasol":     { pb:34,  em:2.55, tipo:"P",  degProt:60, degEner:70, label:"Pellet girasol",                        precioRefUsd:0.25 },
  "Harina sangre":      { pb:80,  em:2.20, tipo:"P",  degProt:80, degEner:60, label:"Harina de sangre (PB alta)",            precioRefUsd:0.50 },
  ...
  "Maíz grano":         { pb:9,   em:3.30, tipo:"E",  degProt:50, degEner:82, label:"Maíz grano (diario - acidosis si bolo)",precioRefUsd:0.22 },
  "Sorgo grano":        { pb:10,  em:3.10, tipo:"E",  degProt:52, degEner:80, label:"Sorgo grano (diario)",                  precioRefUsd:0.18 },
  "Afrechillo trigo":   { pb:15,  em:2.85, tipo:"E",  degProt:60, degEner:76, label:"Afrechillo de trigo",                  precioRefUsd:0.23 },
  "Burlanda húmeda":    { pb:26,  em:2.40, tipo:"EP", degProt:58, degEner:68, label:"Burlanda húmeda (EP - usar fresca)",    precioRefUsd:0.10 },
  "Rollo silaje maíz":  { pb:8,   em:2.50, tipo:"E",  degProt:58, degEner:68, label:"Rollo/Silaje maíz",                    precioRefUsd:0.12 },
  // ── ENERGÉTICO-PROTEICOS (PB 12–30%) ───────────────────────────
  // Indicación: déficit mixto — pasto de baja calidad y baja cantidad simultáneamente
  "Pellet trigo":       { pb:16,  em:3.00, tipo:"EP", degProt:62, degEner:78, label:"Pellet trigo (EP - 2-3x/sem)",          precioRefUsd:0.27 },
  "Mix proteico-energ": { pb:28,  em:2.90, tipo:"EP", degProt:65, degEner:76, label:"Mix proteico-energético",               precioRefUsd:0.30 },
  "Núcleo proteico":    { pb:35,  em:2.70, tipo:"EP", degProt:68, degEner:72, label:"Núcleo proteico-mineral",               precioRefUsd:0.40 },
  "Heno alfalfa":       { pb:18,  em:2.20, tipo:"EP", degProt:55, degEner:60, label:"Heno de alfalfa (EP)",                  precioRefUsd:0.18 },
};
...
const T = {
  // ── Backgrounds ───────────────────────────────────────────────────
  bg:        "#0d1a0b",   // page background — deep forest dark
  bg2:       "#0f1e0d",
  card:      "#141f11",   // card surface
  card2:     "#1a2a16",   // elevated / hover card
  // ── Borders ───────────────────────────────────────────────────────
  border:    "#253b1f",   // quiet separator
  borderMid: "#3c5c34",   // interactive / focus border
  // ── Brand greens (calibrados para fondo oscuro) ───────────────────
  green:     "#5cb83a",   // primary action / accent
  greenD:    "#3e8a26",   // pressed / darker green
  greenDark: "#3e8a26",   // compat alias usado en GraficosBalance
  greenL:    "#7ed45c",   // hover / lighter green
  // ── Status ────────────────────────────────────────────────────────
  amber:     "#d48b2c",   // advertencia / invierno
  orange:    "#d48b2c",   // compat alias
  red:       "#d44d3a",   // crítico / error
  blue:      "#3e9ad8",   // info
  purple:    "#8c5cd8",   // secundario
  // ── Texto ─────────────────────────────────────────────────────────
  text:      "#d6e8d0",   // primary text (warm near-white)
  textDim:   "#87a87e",   // secondary / labels
  textFaint: "#4e6847",   // tertiary / placeholder
  // ── Tipografía ────────────────────────────────────────────────────
  ...
  sh: {
    sm:  "0 1px 4px rgba(0,0,0,.35)",
    base:"0 2px 12px rgba(0,0,0,.45)",
    lg:  "0 4px 24px rgba(0,0,0,.55)",
  },
};
...
const FORM_DEF = {
  ...
  // ── Economía (opcional — si no se carga usa precios de referencia) ──
  precioTerneroUsd:"",   // USD por ternero al destete (ref. NEA: ~320 USD)
  // ── Consulta ───────────────────────────────────────────────────
  consultaEspecifica:"",
};
...
const CLIMA_HIST = {
  ...
  "Misiones":                  [{t:27,p:180},{t:26,p:170},{t:25,p:150},{t:21,p:130},{t:17,p:110},{t:14,p:90},{t:14,p:80},{t:16,p:90},{t:19,p:120},{t:22,p:150},{t:24,p:160},{t:26,p:175}],
