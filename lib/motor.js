...
export {
  ...
  calcScore, diagnosticarSistema,
  calcYm, calcGE_kgMS, calcCH4_kgMS, calcCO2PastizalAnual, calcGEI,
  calcImpactoCola, calcFaseCiclo,
...
const factorN     = (ndvi) => Math.min(1.5, Math.max(0.5, 0.5 + parseFloat(ndvi||0.45)*2));
