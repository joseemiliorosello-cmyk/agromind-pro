...
import { BIOTIPOS, getBiotipo, SUPLEMENTOS, PROD_BASE,
         CALIDAD_C4_CALIBRADA, MESES_NOM, FORM_DEF } from "./constantes";
...
const digConSupl = (digPasto, pbSupl, dosisKg, cvBase) => {
  if (!dosisKg || dosisKg <= 0) return digPasto;
  // Suplemento proteico mejora digestibilidad del pasto C4 (Detmann/NASSEM 2010)
  // Efecto: +1.5 puntos de dig por kg de suplemento proteico (PB>20%)
...
const GWP_CH4  = 27.9;  // CH4 → CO2eq, IPCC AR6 2021 (GWP100 con feedback climático)
const GWP100   = { CH4: 27.9, N2O: 273 };
const AR6      = { GWP_CH4: 27.9, GWP_N2O: 273 };
...
// Devuelve 12 meses con oferta desagregada y demanda para la categoria pedida
// cat: "general" | "vacas_v2s" | "vaq1" | "vaq2"
function balancePorCategoria(motor, form, sat, cat) {
  ...
  for (let i = 0; i < MESES; i++) {
    ...
    const pbBase = (FORRAJE && FORRAJE[veg] && FORRAJE[veg].pb) || 10;
