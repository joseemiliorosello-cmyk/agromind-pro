...
function calcPvEntradaVaq2(pvSalidaVaq1, provincia) {
  ...
  // Sep-Oct (61d): rebrote primaveral C4 → GDP 320 g/d
  // Nov-Dic (61d): pico crecimiento C4, calor+lluvia NEA → GDP 360 g/d
  // Ene-Mar (90d): encañando + calor extremo NEA → GDP 180 g/d
  // Abr-May (58d): declive otoñal C4 → GDP 200 g/d
  // Fuente: Peruchena 2003; Balbuena INTA 2003 — pastizal natural NEA sin suplemento
  const fases = [
    { dias: 61, gdp: 320 }, // sep-oct
    { dias: 61, gdp: 360 }, // nov-dic
    { dias: 90, gdp: 180 }, // ene-mar
    { dias: 58, gdp: 200 }, // abr-may
  ];
  const ganancia = fases.reduce((s, f) => s + f.gdp * f.dias / 1000, 0);
  // gdp promedio ponderado ≈ 256 g/d — pastizal natural NEA
