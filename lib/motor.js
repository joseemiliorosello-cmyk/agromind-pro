...
function calcVaq1(pvEntrada, pvAdulta, ndvi, edadMayo, tipoDestete, disponMS, fenologia, suplReal, dosisRealKg) {
  ...
  return {
    ...
    alertaSinSupl: sinSupl
      ? "⚠️ Sin suplemento: C4 dormante en invierno NEA → GDP " + gdpBase + "g/d (pérdida o mantenimiento). PV agosto estimado: " + Math.round(pv + gdpBase*diasInv/1000) + "kg — " + (Math.round(pv + gdpBase*diasInv/1000) < objetivo ? "NO llega al objetivo de "+objetivo+"kg." : "roza el objetivo pero sin margen.") + " Suplementación proteica imprescindible."
