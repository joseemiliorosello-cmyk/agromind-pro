...
function buildPromptFull(motor, form, sat, cerebro_data) {
  ...
  if (motor?.vaq1E && !motor.vaq1E.mensaje) {
    lines.push("=== VAQUILLONA ===");
    lines.push("1 invierno: PV entrada " + (motor.pvEntVaq1 || "ND") + " kg | GDP pasto: " + motor.vaq1E.gdpPasto + " g/d");
    if (motor?.vaq2E) lines.push("2 invierno: " + (motor.vaq2E.llegas ? "Llega al entore" : "DEFICIT " + ((motor.vaq2E.pvMinEntore||0)-(motor.vaq2E.pvEntore||0)) + " kg para entore"));
    lines.push("");
  }
